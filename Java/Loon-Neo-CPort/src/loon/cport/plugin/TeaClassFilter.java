...
public class TeaClassFilter implements ElementFilter {
	...
	public static void printAllowedClasses() {
		CBuilder.begin("EXCLUDED CLASSES: " + ALLOWED_CLASSES.size());
		for (String allowedClass : ALLOWED_CLASSES) {
			CBuilder.println(allowedClass);
		}
		CBuilder.end();
	}

	public static void printExcludedClasses() {
		CBuilder.begin("ALLOWED CLASES: " + EXCLUDED_CLASSES.size());
		for (String excludedClass : EXCLUDED_CLASSES) {
			CBuilder.println(excludedClass);
		}
		CBuilder.end();
	}
