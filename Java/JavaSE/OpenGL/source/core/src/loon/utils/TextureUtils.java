...
public class TextureUtils {
	...
	public static LTexture[] getSplitTextures(String fileName, int tileWidth, int tileHeight) {
		return getSplitTextures(LTextures.loadTexture(fileName), tileWidth, tileHeight);
	}
	...
	public static LTexture[] getSplitTextures(LTexture image, int tileWidth, int tileHeight) {
		...
		for (int y = 0; y < hlength; y++) {
			for (int x = 0; x < wlength; x++) {
				images[frame] = image.getSubTexture((x * tileWidth), (y * tileHeight), tileWidth,
						tileHeight);
				frame++;
			}
		}
	...
	public static LTexture[][] getSplit2Textures(String fileName, int tileWidth,
			int tileHeight) {
		return getSplit2Textures(LTextures.loadTexture(fileName), tileWidth, tileHeight);
	}
	...
	public static LTexture[][] getSplit2Textures(LTexture image, int tileWidth,
		...
		for (int y = 0; y < hlength; y++) {
			for (int x = 0; x < wlength; x++) {
				textures[x][y] = image.getSubTexture((x * tileWidth), (y * tileHeight), tileWidth,
						tileHeight);
			}
		}
		return textures;
