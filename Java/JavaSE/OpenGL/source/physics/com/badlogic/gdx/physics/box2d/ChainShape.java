...
#include <Box2D/Box2D.h>
	...
	*/
	...
	public void createLoop (Vector2f[] vertices) {
	...
	*/
	 ...
	 * @param vertices an array of vertices, these are copied */
	public void createChain (Vector2f[] vertices) {
		float[] verts = new float[vertices.length * 2];
		for (int i = 0, j = 0; i < vertices.length * 2; i += 2, j++) {
			verts[i] = vertices[j].x;
			verts[i + 1] = vertices[j].y;
	...
	*/
	...
	public void setPrevVertex (Vector2f prevVertex) {
	...
	*/
	...
	public void setNextVertex (Vector2f nextVertex) {
