...
public class PointLight extends BaseLight {
	...
	public PointLight set(final LColor color, final Vector3f position, final float intensity) {
		if (color != null) {
	...
	public PointLight set(final float r, final float g, final float b, final Vector3f position, final float intensity) {
	...
	public PointLight set(final LColor color, final float x, final float y, final float z, final float intensity) {
		if (color != null) {
			this.color.setColor(color);
		}
