...
public class CRC32 implements IV<Long> {
	 ...
	 * @url http://reveng.sourceforge.net/_crcValue-catalogue/17plus.htm
	 */
	...
	public CRC32 update(int d) {
		_crcValue = ((_crcValue >>> 8) ^ CRC_TABLE[(_crcValue ^ (d & 0xFF)) & 0xFF]);
		return this;
	}

	public CRC32 update(byte[] buffer, int offset, int length) {
	...
	public long getValue() {
		return ((long) (_crcValue ^ 0xFFFFFFFF) & 0xFFFFFFFFL);
	}
