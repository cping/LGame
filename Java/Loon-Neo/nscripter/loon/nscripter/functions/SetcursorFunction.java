				   ...
				   int val = (int) ValuesParser.getNumber(_parameters.items[0]);
		            ...
		            switch (val)
		            {
		                case 0:
		                    ...
		                    TextWindow.ClickWaitCursorVector = new Vector2f(Float.parseFloat(_parameters.items[2]), Float.parseFloat(_parameters.items[3]));
		                    break;

		                case 1:
		                    TextWindow.PageWaitCursor = spr;
		                    TextWindow.PageWaitCursorVector = new Vector2f(Float.parseFloat(_parameters.items[2]), Float.parseFloat(_parameters.items[3]));
		                    break;
