...
public class LNBezierTo extends LNBezierBy {
	...
	public static LNBezierTo Action(float t, LNBezierDef c) {
		...
		bezier._originalconfig.controlPoint_1 = new Vector2f(c.controlPoint_1.x, c.controlPoint_1.y);
		bezier._originalconfig.controlPoint_2 = new Vector2f(c.controlPoint_2.x, c.controlPoint_2.y);
		bezier._originalconfig.endPosition = new Vector2f(c.endPosition.x, c.endPosition.y);
		return bezier;
	}
	...
	public void setTarget(LNNode node) {
		...
		_config.controlPoint_1 = _originalconfig.controlPoint_1.sub(_startPosition);
		_config.controlPoint_2 = _originalconfig.controlPoint_2.sub(_startPosition);
