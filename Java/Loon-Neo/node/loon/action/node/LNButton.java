...
public class LNButton extends LNUI {
	...
	public static LNButton buttonWithFadeoutTwinkle(String fsName1, float Opacity) {
	...
	public static LNButton buttonWithTextureTwinkle(String fsName1, String fsName2) {
		LNButton button = new LNButton();
	...
	public static LNButton checkboxWithPressingTexture(String fsName1, String fsName2, String fsName3, String fsName4) {
		LNButton button = new LNButton();
	...
	public void initButtonWithFadeoutTwinkle(String fsName1, float Opacity) {
		...
		LNSequence sequence = LNSequence.Action(new LNAction[] { LNAlphaAction.Action(1f), LNDelay.Action(0.1f),
				LNAlphaAction.Action(0.5f), LNDelay.Action(0.1f) });
		LNAction action3 = LNSequence
				.Action(new LNAction[] { LNRepeat.Action(sequence, 3), LNShow.Action(), LNAlphaAction.Action(1f) });
	...
	public void initButtonWithTextureTwinkle(String fsName1, String fsName2) {
		...
		action2.assignTarget(sprite);
		LNAction action3 = LNSequence.Action(LNRepeat.Action(LNAnimate.Action(anim), 1),
	...
	public void initButtonWithToggleTwinkle(String fsName1) {
		...
		action2.assignTarget(sprite);
		LNSequence sequence = LNSequence.Action(LNToggleVisibility.Action(), LNDelay.Action(0.1f),
				LNToggleVisibility.Action(), LNDelay.Action(0.1f));
		LNAction action3 = LNSequence.Action(LNAlphaAction.Action(1f), LNRepeat.Action(sequence, 1), LNShow.Action(),
	...
	public void initCheckboxWithPrssingTexture(String fsName1, String fsName2, String fsName3, String fsName4) {
		if ((fsName3.equals("")) && (fsName4.equals(""))) {
			...
			LNAction action5 = LNSequence.Action(LNToggleVisibility.Action(), LNFrameAction.Action("Frame", 0));
			...
			LNAction action8 = LNSequence.Action(LNToggleVisibility.Action(), LNFrameAction.Action("Frame", 0));
	...
	public void processTouchReleased() {
		if (isPressed) {
			...
			if (ActionCallBack != null) {
				if (num > 0f) {
					super.runAction(LNSequence.Action(LNDelay.Action(num), LNCallFunc.Action(ActionCallBack)));
				} else {
