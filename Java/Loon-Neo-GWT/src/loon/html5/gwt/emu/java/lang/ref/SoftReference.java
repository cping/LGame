 ...
 * is <a href="package.html#definitions>softly-reachable</a>, the following may
 * happen, either immediately or at a later point:
 *
 * <ul>
 ...
 * guaranteed to be cleared before the VM will throw an
 * {@link java.lang.OutOfMemoryError}.
 *
 * Soft references are useful for caches that should automatically have their
 * entries removed once they are not referenced any more (from outside), and
 * there is a need for memory. The difference between a {@code
