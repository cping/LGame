...
public abstract class Reference<T> {
	...
	/**
	 * Makes the referent {@code null}. This does not force the reference object to
	 * be enqueued.
	 */
	public void clear() {
		return;
	...
	/**
	 * Forces the reference object to be enqueued if it has been associated with a
	 * queue.
	 *
	 * @return {@code true} if this call has caused the {@code Reference} to become
	 *         enqueued, or {@code false} otherwise
	 */
	 ...
	 *
	 * @return the referent to which reference refers, or {@code null} if the object
	 *         has been cleared.
	 */
	public T get() {
		return null;
	 ...
	 * Initialize a newly created reference object. Associate the reference object
	 * with the referent.
	 * 
	 ...
	 * Implement this method to support the provided subclass implementations.
	 * Initialize a newly created reference object. Associate the reference object
	 * with the referent, and the specified ReferenceQueue.
	 * 
	 * @param r the referent
