...
//    }
	...
	/**
	 * Returns the offset of the long array which this buffer is based on, if there
	 * is one.
	 * <p>
	 * The offset is the index of the array and corresponds to the zero position of
	 * the buffer.
	 * </p>
	 *
	...
	/**
	 * Compare the remaining longs of this buffer to another long buffer's remaining
	 * longs.
	 *
	 ...
	 * long buffers are equal if and only if their remaining longs are exactly the
	...
	/**
	 * Reads longs from the current position into the specified long array, starting
	 * from the specified offset, and increase the position by the number of longs
	 * read.
	 *
	 * @param dest the target long array.
	 * @param off  the offset of the long array, must not be negative and not
	 *             greater than {@code
	 * dest.length}.
	 * @param len  the number of longs to read, must be no less than zero and not
	 ...
	 * <p>
	 * A long buffer is direct if it is based on a byte buffer and the byte buffer
	 * is direct.
	 * </p>
	 *
	...
	/**
	 * Writes longs from the given long array to the current position and increases
	...
	/**
	 * Writes longs from the given long array, starting from the specified offset,
	 * to the current position and increases the position by the number of longs
	 * written.
	 *
	 * @param src the source long array.
	 * @param off the offset of long array, must not be negative and not greater
	 *            than {@code src.length}.
	 * @param len the number of longs to write, must be no less than zero and not
