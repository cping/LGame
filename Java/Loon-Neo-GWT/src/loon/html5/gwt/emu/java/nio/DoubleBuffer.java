 ...
 * ByteBuffer.asDoubleBuffer} to create a double buffer based on a byte
 * buffer.</li>
 * </ul>
 */
...
//    }
	 ...
	 * there is one.
	 * <p>
	 * The offset is the index of the array corresponding to the zero position of
	 * the buffer.
	 * </p>
	 *
	 ...
	 * <p>
	 * The remaining doubles will be moved to the head of the buffer, staring from
	 ...
	 * <p>
	 * If {@code other} is not a double buffer then {@code false} is returned. Two
	 * double buffers are equal if and only if their remaining doubles are exactly
	...
	/**
	 * Reads doubles from the current position into the specified double array and
	 * increases the position by the number of doubles read.
	 * <p>
	 ...
	 * @param off  the offset of the double array, must not be negative and not
	 *             greater than {@code
	 * dest.length}.
	 * @param len  the number of doubles to read, must be no less than zero and not
	 ...
	 *
	 * @return {@code true} if this buffer is based on a double array and provides
...
// }
	 ...
	 * <p>
	 * A double buffer is direct if it is based on a byte buffer and the byte buffer
	 * is direct.
	 * </p>
	 *
	...
	/**
	 * Returns the byte order used by this buffer when converting doubles from/to
	 * bytes.
	 * <p>
	 ...
	 * </p>
	 *
	 * @return the byte order used by this buffer when converting doubles from/to
	 *         bytes.
	 */
	 ...
	 * offset, to the current position and increases the position by the number of
	 * doubles written.
	 *
	 * @param src the source double array.
	 * @param off the offset of double array, must not be negative and not greater
	 *            than {@code
	 * src.length}.
	 * @param len the number of doubles to write, must be no less than zero and not
	...
	/**
	 * Write a double to the specified index of this buffer and the position is not
	 * changed.
	 *
