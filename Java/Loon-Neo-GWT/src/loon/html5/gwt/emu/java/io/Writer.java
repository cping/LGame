...
public abstract class Writer implements Appendable, Closeable, Flushable {
	 ...
	 * {@code Writer.write(csq.toString())}. If {@code csq} is {@code null}, then the string "null" is written to the target stream.
	 * 
	 ...
	 * {@code Writer.writer(csq.subsequence(start, end).toString())}. If {@code csq} is {@code null}, then the specified subsequence
	 * of the string "null" will be written to the target.
	 * 
	 * @param csq the character sequence appended to the target.
