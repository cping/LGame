...
public final class ByteBuffer extends Buffer implements Comparable<ByteBuffer>,
		loon.jni.HasArrayBufferView, loon.jni.TypedArrayHelper.Wrapper {
	...
	static ByteBuffer copy(ByteBuffer other, int markOfOther) {
		ByteBuffer buf = new ByteBuffer(other.byteArray.buffer(),
				other.capacity(), other.byteArray.byteOffset());
	...
	public ByteBuffer slice() {
		ByteBuffer slice = new ByteBuffer(byteArray.buffer(), remaining(),
