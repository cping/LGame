...
public final class Array {
	...
	/**
	 * Returns the element of the array at the specified index. This reproduces the
	 * effect of {@code array[index]}. If the array component is a primitive type,
	 * the result is automatically wrapped.
	 *
	 * @param array the array
	 ...
	 * reproduces the effect of {@code array[index] = value}. If the array component
	 * is a primitive type, the value is automatically unwrapped.
	 *
	 * @param array the array
	 * @param index the index
	 ...
	 *                                        the value cannot be converted to the
	 *                                        array type by a widening conversion
	 * @throws ArrayIndexOutOfBoundsException if
	 *                                        {@code  index < 0 || index >= array.length}
	 */
	 ...
	 * @throws NullPointerException           if the {@code array} is {@code null}
	 * @throws IllegalArgumentException       if {@code array} is not an array or
	 *                                        the element at the index position can
	 *                                        not be converted to the return type
	 * @throws ArrayIndexOutOfBoundsException if
	 *                                        {@code index < 0 || index >= array.length}
	 */
	...
	/**
	 * Set the element of the array at the specified index to the {@code int} value.
	 * This reproduces the effect of {@code array[index] = value}.
	 *
	 * @param array the array
	 * @param index the index
	 * @param value the new value
