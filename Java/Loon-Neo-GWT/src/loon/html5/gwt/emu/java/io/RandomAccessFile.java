...
/**
 * Saves binary data to the local storage; currently using hex encoding. The
 * string is prefixed with "hex:"
 * 
 * @author haustein
 */
...
public class RandomAccessFile /* implements DataOutput, DataInput, Closeable */ {
	...
	/*
	 * public final FileDescriptor getFD() throws IOException { } public final
