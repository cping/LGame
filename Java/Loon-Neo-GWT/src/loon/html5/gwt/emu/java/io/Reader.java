...
public abstract class Reader implements Readable, Closeable {
	...
	/***
	 * Closes this reader. Implementations of this method should free any resources
	 ...
	 * <p>
	 * This default implementation simply throws an {@code IOException}; subclasses
	 ...
	 * @throws IOException              if an error occurs while setting a mark in
	 *                                  this reader.
	 * @see #markSupported()
	 * @see #reset()
	 */
	...
	/***
	 * Indicates whether this reader supports the {@code mark()} and {@code reset()}
	 * methods. This default implementation returns {@code false}.
	 * 
	 ...
	 * {@code buf} starting at offset 0. Returns the number of characters actually
	 * read or -1 if the end of the reader has been reached.
	 * 
	 * @param buf character array to store the characters read.
	 * @return the number of characters read or -1 if the end of the reader has been
	 *         reached.
	 * @throws IOException if this reader is closed or some other I/O error occurs.
	 */
	...
	/***
	 * Reads at most {@code count} characters from this reader and stores them at
	 * {@code offset} in the character array {@code buf} . Returns the number of
	 * characters actually read or -1 if the end of the reader has been reached.
	 * 
	 ...
	 * {@code false} if unknown or blocking will occur. This default implementation
	 ...
	 * location. If this reader has not been marked, the behavior of {@code reset()}
	 ...
	 * {@code read} methods will not return these characters unless {@code reset()}
	 * is used. This method may perform multiple reads to read {@code count}
	 * characters.
	 * 
	 * @param count the maximum number of characters to skip.
	 * @return the number of characters actually skipped.
	 * @throws IllegalArgumentException if {@code amount < 0}.
	 * @throws IOException              if this reader is closed or some other I/O
	 *                                  error occurs.
	 * @see #mark(int)
	 * @see #markSupported()
	 * @see #reset()
	 ...
	 * @return the number of characters put into {@code target} or -1 if the end of
	 *         this reader has been reached before a character has been read.
	 * @throws IOException             if any I/O error occurs while reading from
	 *                                 this reader.
