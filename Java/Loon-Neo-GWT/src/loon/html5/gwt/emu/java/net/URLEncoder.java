...
public class URLEncoder {
	...
	/**
	 * Encodes a given string {@code s} in a x-www-form-urlencoded string using the
	 * specified encoding scheme {@code enc}.
	 * <p>
	 ...
	 * @return the encoded string.
	 * @throws UnsupportedEncodingException if the specified encoding scheme is
	 *                                      invalid.
	 */
