...
public class ClassNotFoundException extends Exception {
	...
	/**
	 * Constructs a <code>ClassNotFoundException</code> with the specified detail
	 * message.
	 * 
	 ...
	 * to load the class. Otherwise, returns <tt>null</tt>.
	 * 
	 * <p>
	 * This method predates the general-purpose exception chaining facility. The
	 * {@link Throwable#getCause()} method is now the preferred means of obtaining
	 * this information.
	 * 
	 ...
	 * error occurred while attempting to load the class; otherwise <tt>null</tt>).
	 * 
