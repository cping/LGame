...
public class TDTest extends Screen {
	...
	class MapLayer extends LLayer {
		...
		public MapLayer() {
			...
			pathMap.put(0, Image.createImage("assets/td/sand.png"));
			pathMap.put(1, Image.createImage("assets/td/sandTurn1.png"));
			pathMap.put(2, Image.createImage("assets/td/sandTurn2.png"));
			pathMap.put(3, Image.createImage("assets/td/sandTurn3.png"));
			pathMap.put(4, Image.createImage("assets/td/sandTurn4.png"));
