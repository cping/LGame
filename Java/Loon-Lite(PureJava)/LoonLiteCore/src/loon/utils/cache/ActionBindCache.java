...
public class ActionBindCache extends CacheObject {
	...
	private ActionBind _obj;

	public ActionBindCache(ActionBind obj) {
		this(obj, false);
	}

	public ActionBindCache(ActionBind obj, boolean spawned) {
		super(obj);
		if (obj == null) {
	...
	public void disposed(boolean isShutdown) {
		if (isShutdown) {
			ActionControl.get().removeAllActions(_obj);
		}
	}
}
