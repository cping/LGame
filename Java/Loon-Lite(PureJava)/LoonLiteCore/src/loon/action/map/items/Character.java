 ...
 * 角色模板,提供了一些基础的人物参数
 */
public class Character extends CharacterValue implements ActionBind {
	...
	public Character(int id, CharacterInfo info, String name) {
	...
	public Character(int id, CharacterInfo info, String name, int maxHealth, int maxMana, int attack, int defence,
	...
	public Character setTag(Object t) {
		this._tag = t;
		return this;
	}
