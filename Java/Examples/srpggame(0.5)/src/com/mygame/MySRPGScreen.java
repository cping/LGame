...
public class MySRPGScreen extends SRPGScreen {
	...
	protected void initActorConfig(SRPGActors actors) {
		...
		// 设定脸谱(没有也无所谓)
		p.getActorStatus().face =  LTexture.createTexture("assets/cpf.png");
		// 身份为敌方主角
		...
		hero.getActorStatus().face = LTexture.createTexture("assets/rzf.png");

		hero1 = actors.putActor(2, "鱿鱼娘", "assets/wz.png", 17, 95, 0, 7, 3);
		hero1.setDirection(MOVE_RIGHT);
		hero1.getActorStatus().face = LTexture.createTexture("assets/wzf.png");
