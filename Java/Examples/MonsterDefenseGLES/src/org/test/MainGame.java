...
public class MainGame extends DrawableScreen {
	...
	public final Vector2f getCurrentTouchPos() {
		...
		if (Touch.isDown()) {
			this.touchResult = Touch.getLocation().cpy();
		}
	...
	public final boolean isPressedAnyButton() {
		return Key.isKeyPressed(Key.A) || Key.isKeyPressed(Key.B);
	}
	...
	public final void LoadCnt() {
		...
		this.standardBackTexture = LTextures
				.loadTexture("assets\\standardBack.png");
		this.buttonStatistics = LTextures.loadTexture(this.gfxRoot
				+ "\\menu\\buttons\\buttonStatistics.png");
		this.loadConfig();
		this.playTitleSong();
	...
	public void update(GameTime gameTime) {
		...
		this.currentToucheState = LInputFactory.getTouchState();
	}
