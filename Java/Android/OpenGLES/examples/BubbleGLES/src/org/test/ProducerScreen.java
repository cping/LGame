...
public class ProducerScreen extends MenuScreen {

	private LTexture logo;
	private Drawable[] screens;
	private float screenTime = 0f;

	public ProducerScreen(Drawable... firstScreens) {
		super.transitionOffTime = 1.0f;
	...
	public void draw(SpriteBatch batch, GameTime gameTime) {
		...
		batch.draw(
				...
				new LColor(super.getTransitionAlpha(), super
						.getTransitionAlpha(), super.getTransitionAlpha()));
	}

	@Override
	public void loadContent() {
		this.logo = LTextures.loadTexture("assets/PhreakwaveLogo.png");
	}
	...
	public void update(GameTime gameTime, boolean otherScreenHasFocus,
		...
		this.screenTime += (float) gameTime.getElapsedGameTime();
