...
public class GameMapTest extends SpriteBatchScreen {
	...
	public void create() {
		...
		addActionKey(Key.LEFT, goLeftKey);
		...
		addActionKey(Key.RIGHT, goRightKey);
		...
		if (LSystem.type != ApplicationType.JavaSE) {
			...
			LPad.ClickListener click = new LPad.ClickListener() {
				...
				public void up() {
					pressActionKey(Key.UP);
				}

				public void right() {
					pressActionKey(Key.RIGHT);
				}

				public void left() {
					pressActionKey(Key.LEFT);
				}

				public void down() {
					pressActionKey(Key.DOWN);
				}
