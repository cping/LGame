...
public class Enemy2 extends Enemy {
	...
	public void moveUp2(Map m, Vector<?> things) {
		y -= speed;
		boolean b = false;
	...
	public void moveDown2(Map m, Vector<?> things) {
		y += speed;
		boolean b = false;
	...
	public void moveLeft2(Map m, Vector<?> things) {
		x -= speed;
		boolean b = false;
	...
	public void moveRight2(Map m, Vector<?> things) {
		x += speed;
		boolean b = false;
