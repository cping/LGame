...
public class HtmlGL20  implements GL20 {
	...
	public HtmlGL20 (WebGLRenderingContext gl) {
		this.gl = gl;
	...
	public void glGetIntegerv (int pname, IntBuffer params) {
		if (pname == GL20.GL_ACTIVE_TEXTURE || pname == GL20.GL_ALPHA_BITS || pname == GL20.GL_BLEND_DST_ALPHA
			...
			throw new RuntimeException("glGetFloat not supported by GWT WebGL backend");
	}
	...
	public void glReadPixels (int x, int y, int width, int height, int format, int type, Buffer pixels) {
		...
		if ((format != WebGLRenderingContext.RGBA) || (type != WebGLRenderingContext.UNSIGNED_BYTE)) {
			throw new RuntimeException("Only format RGBA and type UNSIGNED_BYTE are currently supported for glReadPixels(...).");
		}
		if (!(pixels instanceof ByteBuffer)) {
			throw new RuntimeException("Inputed pixels buffer needs to be of type ByteBuffer for glReadPixels(...).");
		}
	...
	public void glBufferData (int target, int size, Buffer data, int usage) {
		if (data instanceof FloatBuffer) {
			...
			throw new RuntimeException("Can only cope with FloatBuffer and ShortBuffer at the moment");
		}
	}
	...
	public void glGetBooleanv (int pname, Buffer params) {
		throw new RuntimeException("glGetBoolean not supported by GWT WebGL backend");
	}
	...
	public void glGetVertexAttribPointerv (int index, int pname, Buffer pointer) {
		throw new RuntimeException("glGetVertexAttribPointer not supported by GWT WebGL backend");
	}
