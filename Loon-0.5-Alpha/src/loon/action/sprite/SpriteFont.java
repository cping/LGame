...
public class SpriteFont {
	...
	public SpriteFont(LTexture tex2d, ArrayList<RectBox> gs,
			ArrayList<RectBox> crops, ArrayList<Character> chars, int line,
			float space, ArrayList<float[]> kern, char def) {
		this.texture = tex2d;
		this.glyphs = gs;
		this.cropping = crops;
		this.charMap = chars;
