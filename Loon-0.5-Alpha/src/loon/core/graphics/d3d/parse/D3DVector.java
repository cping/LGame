...
public class D3DVector {
	...
	public static float dot(D3DVector v1, D3DVector v2) {
		return v1.get(0) * v2.get(0) + v1.get(1) * v2.get(1) + v1.get(2)
				* v2.get(2);
	}
	...
	public static float distance(float x1, float y1, float z1, float x2,
			float y2, float z2) {
		return (float) java.lang.Math.sqrt((x2 - x1) * (x2 - x1) + (y2 - y1)
				* (y2 - y1) + (z2 - z1) * (z2 - z1));
	}

	public static float distance(D3DVector v1, D3DVector v2) {
		return distance(v1.get(0), v1.get(1), v1.get(2), v2.get(0), v2.get(1),
				v2.get(2));
	}
	...
	public static double collideSphere(D3DVector origin, D3DVector direction,
			float sphereRadius, D3DVector spherePosition) {
