...
public class ObjectIntMap<K> implements Iterable<ObjectIntMap.Entry<K>> {
	...
	static public class Entries<K> extends MapIterator<K> implements
			Iterable<Entry<K>>, Iterator<Entry<K>> {
	...
	static public class Keys<K> extends MapIterator<K> implements Iterable<K>,
			Iterator<K> {
