...
import loon.live2d.motion.Live2DMotion;
...
public class L2DBaseModel {
	...
	protected ListMap<String, AMotion> expressions;
	protected ListMap<String, AMotion> motions;
	...
	public L2DBaseModel() {
		...
		motions = new ListMap<String, AMotion>();
		expressions = new ListMap<String, AMotion>();
	}
	...
	public void loadModelData(String path) {
		...
		modelMatrix = new L2DModelMatrix(live2DModel.getCanvasWidth(),
	...
	public void loadExpression(String name, String path) {
		...
		try {
			expressions.put(name,
					L2DExpressionMotion.loadJson(pm.loadBytes(path)));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
