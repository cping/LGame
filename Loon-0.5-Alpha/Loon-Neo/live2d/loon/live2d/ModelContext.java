...
public class ModelContext
{
    ...
    public int getDrawDataIndex(final DrawDataID id) {
        for (int i = this.t.size - 1; i >= 0; --i) {
            if (this.t.get(i) != null && ((IDrawData)this.t.get(i)).i() == id) {
                return i;
            }
        }
        return -1;
    ...
    public IDrawData getDrawData(final DrawDataID id) {
        if (this.u == null) {
            ...
            for (int size = this.t.size, i = 0; i < size; ++i) {
                ...
                final DrawDataID j = drawData.i();
                if (j != null) {
                    this.u.put(j, drawData);
                }
            }
        }
        return (IDrawData) this.u.get(id);
    }
    ...
    public void init() {
        ...
        do {
            ...
            for (int n = 0; n < size4; ++n) {
                ...
                if (baseData2 != null) {
                    ...
                    if (d == null || d == dst_BASE_ID || this.getBaseDataIndex(d) >= 0) {
        ...
        if (paramDefSet != null) {
            final TArray paramDefFloatList = paramDefSet.getParamDefFloatList();
            if (paramDefFloatList != null) {
                for (int size5 = paramDefFloatList.size, n2 = 0; n2 < size5; ++n2) {
                    final ParamDefFloat paramDefFloat = (ParamDefFloat) paramDefFloatList.get(n2);
    ...
    public int getBaseDataIndex(final BaseDataID baseID) {
        for (int i = this.s.size - 1; i >= 0; --i) {
            if (this.s.get(i) != null && ((IBaseData)this.s.get(i)).e() == baseID) {
                return i;
            }
        }
        return -1;
    ...
    public int addFloatParam(final ParamID id, final float value, final float min, final float max) {
    ...
    public int getPartsDataIndex(final PartsDataID partsID) {
        for (int i = this.v.size - 1; i >= 0; --i) {
            if (this.v.get(i) != null && ((PartsData)this.v.get(i)).getPartsDataID() == partsID) {
                return i;
            }
        }
        return -1;
    ...
    public void updateZBuffer_TestImpl(final float startZ, final float stepZ) {
        ...
        for (int i = 0; i < length; ++i) {
            ...
            if (n2 != -1) {
                while (true) {
                    final IDrawContext drawContext = (IDrawContext) this.x.get(n2);
                    if (drawContext.exist()) {
