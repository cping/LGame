...
public abstract class Reader implements Readable, Closeable {
	 ...
	 * occur from this new location. If this reader has not been marked, the behavior of {@code reset()} is implementation specific.
	 * This default implementation throws an {@code IOException}.
	 * 
