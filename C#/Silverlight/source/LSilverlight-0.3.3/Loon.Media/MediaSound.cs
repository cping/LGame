namespace Loon.Media
{
    ...
    public class AudioPlayer : LRelease
    {
        ...
        internal void LoadSong(string path)
        {
            song = LSilverlightPlus.Get.Load<Song>(path);
            isLoaded = true;
        }
    ...
    public class AudioEffect : LRelease
    {
        ...
        internal void LoadAudioEffect(string path)
        {
            soundEffect = LSilverlightPlus.Get.Load<SoundEffect>(path);
