...
namespace Loon.Core.Graphics.OpenGL
{
    public class GL
    {
        ...
        public BasicEffect sEffect = null;

        private float sGreen = 1f;

        public Matrix sMatrix = new Matrix();

        public List<Matrix> sMatrixStack = new List<Matrix>(10);

        public Matrix sProjMatrix = new Matrix();

        private float sRed = 1f;

        private int sTextureId = 0;

        public List<Texture2D> sTextures = new List<Texture2D>();
