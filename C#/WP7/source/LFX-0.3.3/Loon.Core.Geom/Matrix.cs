namespace Loon.Core.Geom {
	...
	public sealed class Matrix {
		...
		public static Matrix CreateRotateTransform(float angle) {
			return new Matrix(Loon.Utils.MathUtils.Cos(angle), -Loon.Utils.MathUtils.Sin(angle), 0,
					Loon.Utils.MathUtils.Sin(angle), Loon.Utils.MathUtils.Cos(angle), 0);
		}
		...
		public void Rotation(float angle) {
			angle = Loon.Utils.MathUtils.PI / 180 * angle;
			float cos = Loon.Utils.MathUtils.Cos(angle);
			float sin = Loon.Utils.MathUtils.Sin(angle);
			this.matrixs[0] = cos;
			this.matrixs[1] = sin;
			this.matrixs[2] = 0;
			this.matrixs[3] = -sin;
		...
		public void RotationX(float angleX) {
			angleX = Loon.Utils.MathUtils.PI / 180 * angleX;
			Set(1f, 0f, 0f, 0f, Loon.Utils.MathUtils.Cos(angleX), -Loon.Utils.MathUtils.Sin(angleX), 0f,
					Loon.Utils.MathUtils.Sin(angleX), Loon.Utils.MathUtils.Cos(angleX));
		}
	
		public void RotationY(float angleY) {
			angleY = Loon.Utils.MathUtils.PI / 180 * angleY;
			Set(Loon.Utils.MathUtils.Cos(angleY), 0f, Loon.Utils.MathUtils.Sin(angleY), 0f, 1f, 0f,
					-Loon.Utils.MathUtils.Sin(angleY), 0f, Loon.Utils.MathUtils.Cos(angleY));
		}
	
		public void RotationZ(float angleZ) {
			angleZ = Loon.Utils.MathUtils.PI / 180 * angleZ;
			Set(Loon.Utils.MathUtils.Cos(angleZ), -Loon.Utils.MathUtils.Sin(angleZ), 0f,
					Loon.Utils.MathUtils.Sin(angleZ), Loon.Utils.MathUtils.Cos(angleZ), 0f, 0f, 0f, 1f);
		}
		...
		public Matrix Invert(Matrix m) {
			...
			float det = Det();
			if (Math.Abs(det) <= Loon.Utils.MathUtils.EPSILON) {
