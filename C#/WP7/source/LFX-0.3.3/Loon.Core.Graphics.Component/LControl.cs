namespace Loon.Core.Graphics.Component
{
    ...
    public class LControl : LComponent
    {
        ...
        public LControl(int x, int y, int bw, int bh, int dw, int dh):  this(x, y,XNAConfig.LoadTex(
                    LSystem.FRAMEWORK_IMG_NAME + "control_base.png"), XNAConfig.LoadTex(LSystem.FRAMEWORK_IMG_NAME + "control_dot.png"),
                    bw, bh, dw, dh)
        {
