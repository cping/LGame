...
namespace Loon.Core.Graphics.Opengl {
	...
	public class LTextureList : LRelease {
		...
		private Dictionary<string, ImageData> imageList;
	
		public LTextureList(string res) : this(Resources.OpenStream(res)) {
		...
		public LTextureList() :this(CollectionUtils.INITIAL_CAPACITY){
			
		}
	
		public LTextureList(int size) :this(true, size){
