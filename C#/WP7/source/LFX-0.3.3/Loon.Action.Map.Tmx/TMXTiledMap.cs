...
namespace Loon.Action.Map.Tmx
{
    public class TMXTiledMap : LRelease
    {
        ...
        public void Draw(GLEx g, int x, int y, int sx, int sy, int width_0, int height_1)
        {
            Draw(g, x, y, sx, sy, width_0, height_1, false);
        }

        public void Draw(GLEx g, int x, int y, int sx, int sy, int width_0,
                int height_1, int index, bool lineByLine)
        {
            TMXLayer layer = (TMXLayer)layers[index];
            layer.Draw(g, x, y, sx, sy, width_0, height_1, lineByLine, tileWidth,
                    tileHeight);
        }

        public void Draw(GLEx g, int x, int y, int sx, int sy, int width_0,
                int height_1, bool lineByLine)
        {
            for (int i = 0; i < layers.Count; i++)
            {
                TMXLayer layer = (TMXLayer)layers[i];
        ...
        protected internal void Draw(GLEx g, int x, int y, int sx, int sy, int width_0,
                int height_1, int layer)
        {
        }
