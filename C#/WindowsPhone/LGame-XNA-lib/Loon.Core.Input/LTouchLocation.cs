...
namespace Loon.Core.Input {
	...
	public class LTouchLocation {
		...
		public void SetPrevPosition(Vector2f v) {
			previousPosition.Set(v);
		}
		...
		public void SetState(LTouchLocationState value_ren) {
			previousState = state;
			state = value_ren;
		}
		...
		public virtual LTouchLocation Clone() {
