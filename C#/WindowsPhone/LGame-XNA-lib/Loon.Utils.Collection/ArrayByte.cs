...
namespace Loon.Utils.Collection
{
    public class ArrayByte
    {
        ...
        public ArrayByte(Stream ins, int t)
        {
        ...
        public void SetLength(int length)
        {
            if (length != data.Length)
            {
                ...
                System.Array.Copy((oldData), 0, (data), 0, Math.Min(oldData.Length, length));
                if (position > length)
                {
                    position = length;
                }
        ...
        public int Read(byte[] buffer, int offset, int length)
        {
            ...
            System.Array.Copy(data, position, buffer, offset, length);
            position += length;
            return length;
        }
        ...
        public void Write(byte[] buffer, int offset, int length)
        {
            ...
            System.Array.Copy((buffer), offset, (data), position, length);
            position += length;
        }
