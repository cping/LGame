...
namespace Loon.Utils
{
    public class MathUtils
    {
        ...
        public static bool IsNan(string str)
        {
            ...
            sz--;
            int i_0 = start;
            while (i_0 < sz || (i_0 < sz + 1 && allowSigns && !foundDigit))
            {
                if (chars[i_0] >= '0' && chars[i_0] <= '9')
                {
                    foundDigit = true;
                    allowSigns = false;
                }
                ...
                else if (chars[i_0] == 'e' || chars[i_0] == 'E')
                {
                    if (hasExp)
                    {
                        return false;
            ...
            if (i_0 < chars.Length)
            {
                ...
                if (chars[i_0] == 'e' || chars[i_0] == 'E')
                {
                    return false;
                }
                if (!allowSigns
                        && (chars[i_0] == 'd' || chars[i_0] == 'D' || chars[i_0] == 'f' || chars[i_0] == 'F'))
                {
                    return foundDigit;
                }
                if (chars[i_0] == 'l' || chars[i_0] == 'L')
                {
        ...
        public static bool IsZero(float value_ren)
        {
            return Math.Abs(value_ren) <= 0.00000001d;
        }
        ...
        static public double Distance(Microsoft.Xna.Framework.Point p1, Microsoft.Xna.Framework.Point p2)
        {
            int dx = p1.X - p2.X;
            int dy = p1.Y - p2.Y;
        ...
        public static int BringToBounds(int minValue,
                int maxValue, int v)
        {
            return Math.Max(minValue, Math.Min(maxValue, v));
        }

        public static float BringToBounds(float minValue,
                float maxValue, float v)
        {
            return Math.Max(minValue, Math.Min(maxValue, v));
        }
        ...
        {
            return (range <= 0) ? 0 : LSystem.random.Next(range);
        }

        public static int NextInt(int start, int end)
        {
            return (end <= 0) ? 0 : start + LSystem.random.Next(end - start);
        }
