...
namespace Loon.Action.Avg
{
    public class AVGCG
    {
        ...
        public void Add(string resName, AVGChara chara)
        {
            ...
            lock (charas)
            {
                chara.SetFlag(ISprite_Constants.TYPE_FADE_OUT, charaShowDelay);
        ...
        public AVGChara Remove(string resName)
        {
            ...
            lock (charas)
            {
                ...
                if (style)
                {
                    ...
                    if (chara != null)
                    {
                        chara.SetFlag(ISprite_Constants.TYPE_FADE_IN, charaShowDelay);
                    }
                }
                else
                {
        ...
        public void Replace(string res1, string res2)
        {
            ...
            lock (charas)
            {
                ...
                if (style)
                {
                    ...
                    if (old != null)
                    {
                        old.SetFlag(ISprite_Constants.TYPE_FADE_IN, charaShowDelay);
                    }
                }
                else
                {
            ...
            lock (charas)
            {
                if (style)
                {
                    for (int i = 0; i < charas.Size(); i++)
                    {
                        ...
                        if (ch != null)
                        {
                            ch.SetFlag(ISprite_Constants.TYPE_FADE_IN, charaShowDelay);
                        }
                    }
                }
                else
