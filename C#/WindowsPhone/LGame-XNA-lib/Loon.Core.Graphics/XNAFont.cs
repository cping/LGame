...
{
    public class XNAFont
    {
         private static XNAFont staticFont;

        public static XNAFont GetDefaultFont()
        {
            return staticFont;
        }
        ...
        public static XNAFont GetFont(string familyName, int size)
        {
            return GetFont(familyName, 0, size);
        }

        public static XNAFont GetFont(string familyName, int style, int size)
        {
            return new XNAFont(familyName, style, size);
        }
        ...
        public XNAFont(string face, int style, int fontSize)
            : this(null, face, style, fontSize)
        {

        }

        public XNAFont(string face)
            : this(null, face)
        {

        }
        public XNAFont(string dir, string face)
            : this(dir, face, 0, 20)
        {

        }

        public XNAFont(string dir, string face, int style, int fontSize)
        {
            if (baseFonts == null)
            {
            ...
            if (spriteFont == null)
            {
                ...
                {
                    if (face.IndexOf("/") == -1 && (FileUtils.GetExtension(face).Length == 0))
                    {
                        face = "Content/" + face;
                    }
                    this.path = face;
        ...
        public static XNAFont GetFromAssetFont(string path, string face, int style, int fontSize)
        {
            return new XNAFont(path, face, style, fontSize);
        }
        ...
        private class Font_Updateable : Updateable
        {
            ...
            public void Action()
            {
                font.spriteFont = LSystem.screenActivity.GameRes.Load<SpriteFont>(font.path);
