...
namespace LLKSample
{
    public class LLKScreen : Screen
    {
        ...
        private class OverClick : ClickListener
        {
            ...
            void ClickListener.DownClick(LComponent comp, float x, float y)
            {
              
            }

            void ClickListener.UpClick(LComponent comp, float x, float y)
            {
